        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="max-w-2xl">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-500/20 backdrop-blur-sm text-white rounded-full mb-6 border border-white/20">
              ...
              <span className="text-sm font-medium"> Retrouve  1M+ de professionnels recherchant la carierre de leur rêve</span>
            </div>
            ...
            <p className="text-xl md:text-2xl text-blue-50 mb-10 leading-relaxed">
              Entrez en contact avec des milliers d'entreprises de premier plan et découvrez des opportunités qui correspondent à vos compétences et à vos passions. c'est entièrement gratuit!            </p>
