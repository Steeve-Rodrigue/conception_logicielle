...
def test_synchroniser_offres_avec_doublons():
    ...
    service.france_travail.rechercher_offres = MagicMock(
        return_value=[
...
def test_synchroniser_offres_echec_dao():
    ...
    service.france_travail.rechercher_offres = MagicMock(
        return_value=[creer_offre_test("1", "Test")]
    )
...
def test_rechercher_offres_locales_avec_localisation():
    ...
    # GIVEN
    service = JobAggregationService()
    service.job_offer_dao.rechercher_offres = MagicMock(
        return_value=[creer_offre_test("1", "Offre Paris")]
    )
...
def test_rechercher_offres_locales_avec_type_contrat():
    ...
    service = JobAggregationService()
    service.job_offer_dao.rechercher_offres = MagicMock(
        return_value=[creer_offre_test("1", "CDI Offre")]
    )
...
def test_rechercher_offres_locales_avec_competences():
    ...
    service = JobAggregationService()
    service.job_offer_dao.rechercher_offres = MagicMock(
        return_value=[creer_offre_test("1", "Python Developer")]
    )
